    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='pepeleria_users', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='pepeleria_users_permissions', to='auth.permission')),
            ],
            options={
                'abstract': False,
            },
